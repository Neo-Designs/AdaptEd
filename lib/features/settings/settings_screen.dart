...
class SettingsScreen extends StatelessWidget {
            ...
            _buildSwitchTile(
             ...
             ListTile(
              leading: const Icon(Icons.logout, color: Colors.red),
               title: Text("Log Out", style: theme.bodyStyle.copyWith(color: Colors.red)),
               onTap: () async {
  ...
  Widget _buildSwitchTile(DynamicTheme theme, String title, String subtitle, bool value, Function(bool) onChanged) {
