            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Expanded(child: Text(title, style: const TextStyle(color: Colors.grey, fontSize: 13))),
                ],
              ),
              const SizedBox(height: 8),
      ...
      children: [
        const Row(
          children: [
            ...
            SizedBox(width: 8),
            Expanded(child: Text("System Feed: Registered Users", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold))),
          ],
        ),
        const SizedBox(height: 16),
        Container(
      ...
      children: [
        const Row(
          children: [
            ...
            SizedBox(width: 8),
            Expanded(child: Text("System Feed: Recent Documents", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold))),
          ],
        ),
        const SizedBox(height: 16),
        Container(
      ...
      children: [
        const Row(
          children: [
            ...
            SizedBox(width: 8),
            Expanded(child: Text("System Feed: User Feedback & Reviews", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold))),
          ],
        ),
        const SizedBox(height: 16),
        Container(
