...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  Widget _buildCountCard(
      String title, IconData icon, Stream<String> countStream) {
    return Expanded(
      child: Card(
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        for (var doc in snapshot.data!.docs) {
          ...
          if (timestamp != null) {
            ...
            final differenceInDays =
                todayMidnight.difference(docMidnight).inDays;
        ...
        return Container(
          height: 250,
          padding:
              const EdgeInsets.only(right: 16, left: 0, top: 16, bottom: 16),
          decoration: BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.circular(12),
              border: Border.all(color: Colors.grey[200]!)),
  ...
  void _showDocumentMetadata(BuildContext context, String docId, String title,
      String userId, String dateStr) {
    showDialog(
      context: context,
